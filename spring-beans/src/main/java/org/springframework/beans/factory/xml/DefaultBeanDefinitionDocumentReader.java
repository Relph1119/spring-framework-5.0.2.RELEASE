...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
	 ...
	 */
	// 根据Spring DTD将Bean的定义规则解析Bean定义的文档对象
	@Override
	...
	protected void parseBeanDefinitions(Element root, BeanDefinitionParserDelegate delegate) {
		// Bean 定义的文档对象使用了Spring默认的XML命名空间
	...
	private void parseDefaultElement(Element ele, BeanDefinitionParserDelegate delegate) {
		...
		// 如果节点既不是导入元素，也不是别名元素，而是普通<bean>元素，则按照Spring的Bean规则解析元素
	...
	protected void processBeanDefinition(Element ele, BeanDefinitionParserDelegate delegate) {
		// BeanDefinitionHolder 是对 BeanDefinition的封装，即Bean定义的封装类
		// 对文档对象中<bean>元素的解析由 BeanDefinitionParserDelegate实现
